  ...
  try {
    ...
    const bookings = await client.query(`
      SELECT 
        ...
        b.status,
        COALESCE(b.payment_status, 'paid') as "paymentStatus",
        'card' as "paymentMethod",
        b.booking_reference as "paymentIntentId",
        b.notes as notes,
        COALESCE(b.number_of_attendees, 1) as attendees,
...
// Admin schedules endpoint - bypassing auth temporarily
  ...
  try {
    ...
    const query = `
      SELECT
        ...
        c.learning_outcomes,
        c.prerequisites,
        c.included_materials,
        c.target_audience,
        c.accreditation_body,
        c.certification_validity_years,
        c.stripe_product_id,
        c.stripe_price_id,
        cs.total_bookings,
