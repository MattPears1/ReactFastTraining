-- Update Email Templates with Professional HTML Design
...
-- Update session_cancellation template
UPDATE email_templates 
SET 
...
HSE Approved | Ofqual Regulated | Saving Lives Through Education
https://reactfasttraining.co.uk'
WHERE name = 'session_cancellation';

-- Update session_reminder_24h template
UPDATE email_templates 
SET 
...
HSE Approved | Ofqual Regulated | Saving Lives Through Education
https://reactfasttraining.co.uk'
WHERE name = 'session_reminder_24h';

-- Show what templates we updated
SELECT name, subject FROM email_templates WHERE name IN ('booking_confirmation', 'session_cancellation', 'session_reminder_24h');