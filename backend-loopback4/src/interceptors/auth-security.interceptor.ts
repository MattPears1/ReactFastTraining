...
export class AuthSecurityInterceptor implements Provider<Interceptor> {
  ...
  private applySecurityHeaders(): void {
    ...
    const headers = {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' http://localhost:3000 https://api.stripe.com;",
