...
export const SettingsPage: React.FC = () => {
  ...
  const [companyEmail, setCompanyEmail] = useState('info@reactfasttraining.co.uk');
  const [companyPhone, setCompanyPhone] = useState('01234 567890');
  const [companyAddress, setCompanyAddress] = useState('123 Training Street, Leeds, LS1 1AA');
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  type="email"
                  value={companyEmail}
                  onChange={(e) => { setCompanyEmail(e.target.value); handleChange(); }}
                  className="admin-input"
                />
              </div>
              <div>
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                ...
                <input
                  ...
                  onChange={(e) => { setEmailNotifications(e.target.checked); handleChange(); }}
                  className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
                />
              </label>

              <div className={`space-y-4 ml-8 ${!emailNotifications ? 'opacity-50' : ''}`}>
                <label className="flex items-center justify-between p-3">
                  <div>
                    <div className="font-medium text-gray-900">New Booking Alerts</div>
                    <div className="admin-text-small admin-text-muted">
                  ...
                  <input
                    ...
                    onChange={(e) => { setNewBookingAlert(e.target.checked); handleChange(); }}
                ...
                <label className="flex items-center justify-between p-3">
                  ...
                  <input
                    ...
                    onChange={(e) => { setCancellationAlert(e.target.checked); handleChange(); }}
                    disabled={!emailNotifications}
                    className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
                  />
                </label>
                ...
                <label className="flex items-center justify-between p-3">
                  <div>
                    <div className="font-medium text-gray-900">Payment Failure Alerts</div>
                    <div className="admin-text-small admin-text-muted">
                  ...
                  <input
                    ...
                    onChange={(e) => { setPaymentFailureAlert(e.target.checked); handleChange(); }}
                    disabled={!emailNotifications}
                    className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
                  />
                </label>
                ...
                <label className="flex items-center justify-between p-3">
                  ...
                  <input
                    type="checkbox"
                    checked={dailyReport}
                    onChange={(e) => { setDailyReport(e.target.checked); handleChange(); }}
                    disabled={!emailNotifications}
                    className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
                  />
                </label>
      ...
      case 'booking':
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="admin-label">Minimum Booking Advance (hours)</label>
                <input
                  type="number"
                  value={minBookingAdvance}
                  onChange={(e) => { setMinBookingAdvance(e.target.value); handleChange(); }}
                  className="admin-input"
                  min="0"
                />
              ...
              <div>
                <label className="admin-label">Maximum Booking Advance (days)</label>
                <input
                  type="number"
                  value={maxBookingAdvance}
                  onChange={(e) => { setMaxBookingAdvance(e.target.value); handleChange(); }}
                  className="admin-input"
                  min="1"
                />
                <p className="admin-text-small admin-text-muted admin-mt-1">
              ...
              <div>
                <label className="admin-label">Cancellation Deadline (hours)</label>
                <input
                  type="number"
                  value={cancellationDeadline}
                  onChange={(e) => { setCancellationDeadline(e.target.value); handleChange(); }}
                  className="admin-input"
                  min="0"
                />
                <p className="admin-text-small admin-text-muted admin-mt-1">
            ...
            <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
              <div>
                <div className="font-medium text-gray-900">Automatic Reminders</div>
                <div className="admin-text-small admin-text-muted">
              ...
              <input
                ...
                onChange={(e) => { setAutomaticReminders(e.target.checked); handleChange(); }}
                className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
              />
            </label>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-800">
                    <strong>Warning:</strong> Changes to payment settings may affect live transactions. 
            ...
            <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
              ...
              <input
                ...
                onChange={(e) => { setStripeEnabled(e.target.checked); handleChange(); }}
                className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
              />
            </label>
              ...
              <div className="space-y-4 ml-8">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => { setStripePublicKey(e.target.value); handleChange(); }}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => { setStripeSecretKey(e.target.value); handleChange(); }}
                    className="admin-input font-mono text-sm"
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => { setEnableTestMode(e.target.checked); handleChange(); }}
          ...
          <div className="space-y-6">
            <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
              ...
              <input
                ...
                onChange={(e) => { setTwoFactorEnabled(e.target.checked); handleChange(); }}
                className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
              />
            </label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => { setPasswordComplexity(e.target.value); handleChange(); }}
                  className="admin-select"
                >
                  <option value="low">Low (8+ characters)</option>
                  <option value="medium">Medium (8+ chars, mixed case)</option>
                  <option value="high">High (8+ chars, mixed case, numbers, symbols)</option>
                </select>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                ...
                <input
                  ...
                  onChange={(e) => { setMaintenanceMode(e.target.checked); handleChange(); }}
                  className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
                />
              </label>
              ...
              <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                ...
                <input
                  type="checkbox"
                  checked={debugMode}
                  onChange={(e) => { setDebugMode(e.target.checked); handleChange(); }}
                  className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
                />
              </label>
              ...
              <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                ...
                <input
                  type="checkbox"
                  checked={autoBackup}
                  onChange={(e) => { setAutoBackup(e.target.checked); handleChange(); }}
                  className="h-5 w-5 text-primary-600 rounded focus:ring-primary-500"
                />
              </label>
              ...
              {autoBackup && (
                <div className="ml-8">
                  ...
                  <select
                    ...
                    onChange={(e) => { setBackupFrequency(e.target.value); handleChange(); }}
                    className="admin-select w-48"
                  >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <AdminCard noPadding>
            <nav className="space-y-1 p-2">
              {settingSections.map((section) => (
                ...
                >
                  <div className={activeSection === section.id ? 'text-primary-500' : 'text-gray-400'}>
                    {section.icon}
                  </div>
        ...
        <div className="lg:col-span-3">
          <AdminCard
            ...
            icon={() => settingSections.find(s => s.id === activeSection)?.icon}
          >
