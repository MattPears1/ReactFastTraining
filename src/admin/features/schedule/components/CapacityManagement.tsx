...
export const CapacityManagement: React.FC<CapacityManagementProps> = ({
  ...
  const getCapacityColor = () => {
    if (capacityInfo.capacityPercentage >= 100)
      return "text-red-600 bg-red-100";
    if (capacityInfo.capacityPercentage >= 80)
    ...
    >
      <div className="space-y-6">
        ...
        <div className="text-center">
          <div
            className={`inline-flex items-center justify-center px-8 py-4 rounded-xl shadow-inner transition-all duration-300 ${getCapacityColor()}`}
          >
        ...
        <div>
            ...
            <span
              className={`font-semibold ${
                capacityInfo.capacityPercentage >= 100
                  ? "text-red-600"
                  : capacityInfo.capacityPercentage >= 80
                    ? "text-yellow-600"
                    : "text-green-600"
              }`}
            >
          ...
          <div className="relative w-full bg-gray-100 rounded-full h-6 overflow-hidden shadow-inner">
            <div
              ...
              style={{
                width: `${Math.min(capacityInfo.capacityPercentage, 100)}%`,
              }}
            >
              ...
              <div className="flex items-start space-x-2 p-3 bg-yellow-50 rounded-lg">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-yellow-700">
                    Only {capacityInfo.availableSpots} spots remaining. Consider
                    opening a waitlist.
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-start space-x-2 p-3 bg-red-50 rounded-lg">
              ...
              <div className="text-sm">
                ...
                <p className="text-red-700">
                  No spots available. New bookings will be added to the
                  waitlist.
                </p>
              </div>
            </div>
