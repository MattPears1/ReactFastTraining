...
export const ScheduleDetailsPage: React.FC = () => {
  ...
  const updateSessionMutation = useMutation({
    ...
    onError: (error: any) => {
      addNotification({
        type: "error",
        title: error.message || "Failed to update session",
      });
    },
  });
  ...
  const cancelSessionMutation = useMutation({
    ...
    onError: (error: any) => {
      addNotification({
        type: "error",
        title: error.message || "Failed to cancel session",
      });
    },
  });
  ...
  const duplicateSessionMutation = useMutation({
    ...
    onSuccess: (newSession) => {
      addNotification({
        type: "success",
        title: "Session duplicated successfully",
      });
    ...
    onError: (error: any) => {
      addNotification({
        type: "error",
        title: error.message || "Failed to duplicate session",
      });
    },
  });
  ...
  const emailAttendeesMutation = useMutation({
    ...
    onSuccess: (result) => {
      addNotification({
        type: "success",
        title: `Email sent to ${result.sent} attendees`,
      });
    },
    onError: (error: any) => {
      addNotification({
        type: "error",
        title: error.message || "Failed to send emails",
      });
    },
  });
  ...
  const handleExportAttendees = async (format: "csv" | "pdf" = "csv") => {
    ...
    try {
      ...
      addNotification({
        type: "success",
        title: "Attendee list exported successfully",
      });
    } catch (error) {
      addNotification({
        type: "error",
        title: "Failed to export attendee list",
      });
    }
  };
  ...
  const handlePrintSignInSheet = async () => {
    ...
    try {
      ...
      addNotification({
        type: "error",
        title: "Failed to generate sign-in sheet",
      });
    }
  };
        ...
        <div className="text-center space-y-6 schedule-fade-in max-w-md mx-auto px-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600">
              We couldn't retrieve the session details. Please try again.
            </p>
          </div>
          <Button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6 order-2 lg:order-1">
            <div
              className="schedule-stagger-item"
              ...
              >
                <FinancialSummary
                  ...
                  onProcessRefunds={() => {
                    addNotification({
                      type: "info",
                      title: "Refund processing coming soon",
                    });
                  }}
