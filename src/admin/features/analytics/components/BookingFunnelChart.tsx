...
import { Eye, MousePointer, ShoppingCart, CheckCircle, XCircle } from 'lucide-react';
...
export const BookingFunnelChart: React.FC<Props> = ({ data }) => {
  ...
  const stages = [
    ...
    },
    {
      ...
      percentage: safeData.visitors > 0 ? (safeData.coursesViewed / safeData.visitors) * 100 : 0
    },
    {
      ...
      percentage: safeData.visitors > 0 ? (safeData.bookingStarted / safeData.visitors) * 100 : 0
    },
    {
      ...
      percentage: safeData.visitors > 0 ? (safeData.bookingCompleted / safeData.visitors) * 100 : 0
    }
  ];
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {stages.map((stage, index) => (
          <div key={stage.name} className="relative">
            <div className={`p-4 rounded-lg ${stage.color} transition-all hover:scale-105`}>
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg">
        <h3 className="text-sm font-medium text-gray-700 mb-2">Conversion Summary</h3>
