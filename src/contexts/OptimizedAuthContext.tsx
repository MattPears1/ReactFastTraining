...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const logout = useCallback(async () => {
    ...
    try {
      ...
      if (sessionCheckInterval.current) clearTimeout(sessionCheckInterval.current)
  ...
  const value = useMemo<AuthContextType>(
    ...
    [user, isLoading, isAuthenticated, error, login, signup, logout, clearError, checkAuth]
  )
