...
const TestComponent = () => {
  ...
  return (
    <div>
      ...
      <button onClick={() => showSystemAlert({
        type: 'warning',
        title: 'System Alert',
...
describe('NotificationContext', () => {
  ...
  it('loads notifications from localStorage', () => {
    ...
    localStorage.setItem('app_notifications', JSON.stringify(storedNotifications))
    ...
    expect(screen.getByText('Stored Notification - unread')).toBeInTheDocument()
  })
  ...
  it('handles corrupted localStorage data gracefully', () => {
    ...
    expect(screen.getByTestId('notification-count')).toHaveTextContent('0')
    expect(consoleSpy).toHaveBeenCalledWith('Failed to parse stored notifications', expect.any(Error))
  ...
  it('shows and dismisses system alerts', async () => {
    ...
    expect(screen.getByTestId('system-alert')).toHaveTextContent('System Alert')
