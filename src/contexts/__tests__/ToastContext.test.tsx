...
describe('ToastContext', () => {
  ...
  it('shows success toast with correct styling', async () => {
    ...
    expect(toast).toHaveClass('bg-success-50', 'text-success-800', 'border-success-200')
  })
  ...
  it('shows error toast with custom duration', async () => {
    ...
    expect(toast).toHaveClass('bg-error-50', 'text-error-800', 'border-error-200')
  })
  ...
  it('shows warning toast persistently when duration is 0', async () => {
    ...
    expect(toast).toHaveClass('bg-warning-50', 'text-warning-800', 'border-warning-200')
  ...
  it('allows manual dismissal of toast', async () => {
    ...
    const closeButton = screen.getByText('Success message')
      .closest('div')
  ...
  it('positions toasts in the correct location', async () => {
    ...
    const toastContainer = screen.getByText('Success message').closest('.fixed')
