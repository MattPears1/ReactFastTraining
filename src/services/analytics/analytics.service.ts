import { getCookieConsent, hasCookieConsent } from '@/components/ui/CookieConsent'
...
class AnalyticsService {
  ...
  private loadGoogleAnalytics() {
    ...
    window.gtag('consent', 'default', {
      ...
      'functionality_storage': hasCookieConsent('preferences') ? 'granted' : 'denied',
      'personalization_storage': hasCookieConsent('preferences') ? 'granted' : 'denied',
  ...
  setUser(userId: string, properties?: UserProperties) {
    ...
    if (window.gtag && hasCookieConsent('analytics')) {
      ...
      if (properties) {
        window.gtag('set', 'user_properties', this.sanitizeProperties(properties))
      }
    }
