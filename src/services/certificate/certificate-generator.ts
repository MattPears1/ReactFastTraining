...
export class CertificateGenerator {
  ...
  generateCertificate(data: CertificateData): string {
    ...
    this.doc.text("Certificate of Completion", pageWidth / 2, 40, {
      align: "center",
    });
    ...
    this.doc.text("This is to certify that", pageWidth / 2, 55, {
      align: "center",
    });
    ...
    this.doc.setTextColor(100, 100, 100);
    this.doc.text("has successfully completed the", pageWidth / 2, 90, {
      align: "center",
    });
    ...
    this.doc.setTextColor(100, 100, 100);
    this.doc.text(
      `on ${data.courseDate} at ${data.location}`,
      pageWidth / 2,
      120,
      { align: "center" },
    );
