export const mockCourseSchedules = [
  {
    ...
    venue: "SHEFFIELD",
    venueName: "Sheffield Area",
    venueAddress: "Location to be confirmed",
    availableSpots: 8,
    maxParticipants: 12,
    pricePerPerson: 100,
    instructorName: "Lex",
