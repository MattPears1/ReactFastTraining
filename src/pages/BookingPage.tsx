...
const BookingPage: React.FC = () => {
  ...
  const handleCourseSelect = (
    course: SelectedCourse & { isInquiry?: boolean },
  ) => {
        ...
        .then((data) => {
          ...
          if (data.session.stillAvailable) {
            ...
            setSelectedCourse({
              ...
              courseType: courseDetails.courseName
                .toLowerCase()
                .replace(/ /g, "-"),
              ...
              maxParticipants:
                data.session.availableSpaces + data.inquiry.numberOfPeople,
            ...
            showToast(
              "success",
              "Your inquiry details have been loaded. Please complete your booking.",
            );
          } else {
            showToast(
              "error",
              "Sorry, there are no longer enough spaces available for your group.",
            );
          }
        })
        .catch((err) => {
          showToast(
            "error",
            "Could not load your inquiry. It may have expired or been used already.",
          );
        ...
        <div className="container">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <div className="flex items-center justify-between relative">
              ...
              {(
                ["select-course", "details", "confirmation"] as BookingStep[]
              ).map((step, index) => {
              ...
              >
                <BookingForm
                  ...
                  onSuccess={(code, price, email, phone, participants) => {
                    ...
                    if (inquiryRef) {
                      fetch(`/api/bookings/inquiry/${inquiryRef}/expire`, {
                        method: "POST",
                      });
                    }
                  }}
                ...
                <div className="max-w-2xl mx-auto">
                  <div className="mb-8">
                    ...
                    <p className="text-lg text-gray-600 mb-6">
                      Thank you for your interest. We've received your inquiry
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-left">
                      ...
                      <ul className="space-y-2 text-blue-800">
                        <li className="flex items-start">
                          ...
                          Our instructor will review your inquiry and check
                          availability
                        </li>
                        <li className="flex items-start">
                          <span className="text-blue-600 mr-2">2.</span>
                          You'll receive a detailed response answering any
                          questions
                        </li>
                        <li className="flex items-start">
                          <span className="text-blue-600 mr-2">3.</span>
                          We'll provide instructions on how to complete your
                          booking
                        </li>
                        <li className="flex items-start">
                    ...
                    <p className="text-sm text-gray-600 mt-6">
                      Check your email for a confirmation of your inquiry. If
