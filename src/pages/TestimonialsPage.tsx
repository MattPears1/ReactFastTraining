...
const TestimonialsPage: React.FC = () => {
  ...
  const filteredTestimonials = testimonials.filter(
    (t) => filterCourse === "all" || t.courseTaken === filterCourse,
  );
      ...
      <section className="relative bg-gradient-to-r from-primary-600 to-primary-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-primary-50">
            Hear from our satisfied students about their training experience
          </p>
          ...
          <div className="mb-8 flex flex-col sm:flex-row gap-4 justify-between">
            <div className="flex flex-col sm:flex-row gap-4">
              <select
                ...
                onChange={(e) =>
                  setFilterCourse(
                    e.target.value === "All Courses" ? "all" : e.target.value,
                  )
                }
            ...
            <>
              ...
              {sortedTestimonials.some((t) => t.rating === 5) && (
                <div className="mb-12">
                  ...
                  <TestimonialCard
                    testimonial={
                      sortedTestimonials.find((t) => t.rating === 5)!
                    }
                    variant="featured"
                  />
                </div>
  ...
  return [
    {
      ...
      content:
        "Absolutely brilliant course! The instructor was incredibly knowledgeable and made everything easy to understand. The hands-on practice really helped build my confidence. I now feel prepared to handle emergency situations both at work and in everyday life. Highly recommend React Fast Training!",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "As a nursery teacher, this course was invaluable. The instructor covered everything from basic first aid to specific scenarios with infants and children. The small class size meant we all got plenty of hands-on practice. I especially appreciated the sections on choking and CPR for different age groups.",
      rating: 5,
      photoUrl: "https://via.placeholder.com/150",
      showFullName: true,
      verifiedBooking: true,
    ...
    },
    {
      ...
      content:
        "Comprehensive three-day course that covered everything from minor injuries to serious medical emergencies. The balance between theory and practical sessions was perfect. Our instructor Lex was fantastic - patient, encouraging, and clearly passionate about first aid. Worth every penny!",
      rating: 5,
      photoUrl: "https://via.placeholder.com/150",
      showFullName: true,
      verifiedBooking: true,
    ...
    },
    {
      ...
      content:
        "Excellent fire safety training that went beyond just using extinguishers. We learned about fire prevention, evacuation procedures, and different types of fires. The practical session with real fire extinguishers was particularly valuable. Feeling much more confident about workplace safety now.",
      rating: 4,
      photoUrl: null,
      showFullName: true,
      verifiedBooking: true,
