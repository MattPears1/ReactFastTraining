...
export const BookingsReport: React.FC<BookingsReportProps> = ({ data, dateRangeLabel }) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{data.bookings.total}</p>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600 mt-1">{data.bookings.completed}</p>
              <p className="text-sm text-gray-500 mt-2">{completionRate.toFixed(1)}% rate</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-red-600 mt-1">{data.bookings.cancelled}</p>
              <p className="text-sm text-gray-500 mt-2">{cancellationRate.toFixed(1)}% rate</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-600 mt-1">{data.bookings.refunded}</p>
              <p className="text-sm text-gray-500 mt-2">
                {((data.bookings.refunded / data.bookings.total) * 100).toFixed(1)}% rate
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Booking Metrics</h3>
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-700">Refund Rate</span>
                <span className="text-sm font-bold text-yellow-600">
                  {((data.bookings.refunded / data.bookings.total) * 100).toFixed(1)}%
                </span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div 
                  className="bg-yellow-600 h-2 rounded-full transition-all duration-300"
                  style={{ width: `${(data.bookings.refunded / data.bookings.total) * 100}%` }}
                />
              </div>
            </div>
          </div>
