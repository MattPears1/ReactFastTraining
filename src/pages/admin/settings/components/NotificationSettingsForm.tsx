          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">
                  Send reminder email before the session
                </p>
              </div>
              <ToggleSwitch
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">
                  Notify customers if a session is cancelled
                </p>
              </div>
              <ToggleSwitch
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">
                  Alert when session capacity is below threshold
                </p>
              </div>
              <ToggleSwitch
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-blue-700 mt-1">
                ...
                <strong>noreply@reactfasttraining.co.uk</strong>. Make sure this
                address is added to your email provider's whitelist to ensure
                delivery.
              </p>
            </div>
          </div>
