  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'Create Session', icon: Calendar, href: '/admin/sessions/new' }
      ]
    },
    {
      label: 'Bookings',
      ...
      children: [
        ...
        { label: 'Pending', icon: Users, href: '/admin/bookings?status=pending' },
    ...
    },
    {
      ...
      children: [
        { label: 'Email Templates', icon: Mail, href: '/admin/emails/templates' },
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              ...
              Please save your work and stay active to avoid being logged out.
            </p>
