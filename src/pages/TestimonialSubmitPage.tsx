      ...
      <section className="relative bg-gradient-to-r from-primary-600 to-primary-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-primary-50">
            Your feedback helps us improve and helps others choose the right
            course
          </p>
        </div>
      </section>
          ...
          >
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-8">
                Your testimonial helps future students make informed decisions
                about their training. Please share your honest experience with
                React Fast Training.
              </p>
