...
const FAWRequalificationPage: React.FC = () => {
  const courseData = {
    ...
    seoKeywords: 'first aid at work requalification Yorkshire, FAW refresher course South Yorkshire, FAW renewal South Yorkshire, first aid requalification training'
  }
