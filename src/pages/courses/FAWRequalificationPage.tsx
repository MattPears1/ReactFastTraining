...
const FAWRequalificationPage: React.FC = () => {
  const courseData = {
    ...
    description:
      "This course is for those who need to renew their FAW certificate. It serves as a comprehensive refresher of the course content, ensuring that first aiders are up-to-date with any changes in protocols and maintain their competency.",
    ...
    prerequisites:
      "Valid or recently expired (within 1 month) First Aid at Work certificate",
