...
const AnnualSkillsRefresherPage: React.FC = () => {
  const courseData = {
    ...
    learningOutcomes: [
      "Recap key lifesaving skills such as CPR and AED use",
    ...
    accreditations: [
      "HSE Recommended",
      "First Aid Industry Body (FAIB) Endorsed",
    ...
    assessmentMethod:
      "Practical participation and skills demonstration - no formal assessment",
