        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto">
              The most comprehensive first aid qualification for workplace first
              aiders. Learn life-saving skills in one intensive, practical
              training day.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                This course is ideal for anyone who needs to be a qualified
                first aider in their workplace. The HSE recommends that all
                workplaces have adequate first aid provision.
              </p>
        ...
        <div className="container">
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                With extensive experience in high-risk environments including
                military service and law enforcement, Lex brings real-world
                expertise to every training session. You'll learn practical
                skills that work in real emergencies, not just textbook theory.
              </p>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
              Join our next First Aid at Work course and gain essential
            ...
            <p className="mt-6 text-white/80">
              Group bookings available • On-site training options • Flexible
              scheduling
            </p>
          </motion.div>
        </div>
