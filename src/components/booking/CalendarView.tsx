...
import { 
  ...
  Users, AlertCircle, ChevronDown, ChevronUp, X 
} from 'lucide-react';
        ...
        <div className="p-4 sm:p-6 border-b dark:border-gray-700">
          ...
          <div className="grid grid-cols-7 gap-0 text-center">
            {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((day, index) => (
              <div key={index} className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 py-1 sm:py-2">
        ...
        <div className="p-3 sm:p-4 md:p-6 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-xs sm:text-sm">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="text-gray-600 dark:text-gray-400">Tap to view</span>
            </div>
          </div>
        </div>
      </div>
