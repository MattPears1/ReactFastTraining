...
export const BookingInquiryForm: React.FC<BookingInquiryFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(
        "success",
        "Your inquiry has been sent and your spot has been reserved for 24 hours! We'll respond within 24 hours.",
      );
      onSuccess();
    } catch (error) {
    ...
    >
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Send us your questions and booking request. We'll respond within 24
          hours.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        ...
        <div className="space-y-1 text-sm text-blue-800">
          <p>
            <span className="font-medium">Course:</span> {courseConfig.name}
          </p>
          <p>
          ...
          <div className="flex items-start">
            ...
            <div className="text-sm text-amber-800">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>
                  When you send this message, this spot will be reserved for 24
                  hours
                </li>
                <li>We will get back to you within 24 hours</li>
                <li>Therefore you can book it if you still want</li>
                <li>
                  When the instructor responds, the link to the booking slot
                  that is reserved will appear so that you can continue to book
                  if necessary
                </li>
              </ul>
            </div>
        ...
        <div>
          <label className="flex items-start">
            ...
            <span className="text-sm text-gray-600">
              I would like to receive updates about future courses and first aid
              tips from React Fast Training
            </span>
          </label>
        </div>
