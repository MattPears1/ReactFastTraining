...
import { Check, Calendar, FileText, CreditCard, CheckCircle } from 'lucide-react';
import { cn } from '@utils/cn';

export type BookingStep = 'select-course' | 'details' | 'payment' | 'confirmation';
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                completed && !active && 'border-green-500 bg-green-50 dark:bg-green-900/20',
                !active && !completed && 'border-gray-200 dark:border-gray-700',
                accessible && onStepClick && 'cursor-pointer hover:border-gray-300',
            ...
            >
              ...
              <div className="flex-1">
                <h4 className={cn(
                  ...
                  completed && !active && 'text-green-900 dark:text-green-100'
                )}>
                  {step.label}
                </h4>
              ...
              >
                <motion.div
                  ...
                  className={cn(
                    ...
                    completed && !active && 'bg-green-500 text-white',
                    !active && !completed && 'bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600',
                    !accessible && 'opacity-50'
                  )}
                >
                  {completed && !active ? (
