...
const bookingFAQs: FAQItem[] = [
  {
    ...
    answer:
      "We accept all major credit and debit cards (Visa, Mastercard, American Express), bank transfers for corporate bookings, and payment on invoice for approved accounts. All payments are processed securely through our encrypted payment system.",
  },
  {
    id: "cancellation",
    question: "What is your cancellation policy?",
    answer:
      "You can cancel or reschedule your booking up to 5 working days before the course date for a full refund. Cancellations within 5 days may be subject to a cancellation fee. In case of illness, we offer free rescheduling with a medical certificate.",
  },
  {
    id: "group",
    question: "Do you offer discounts for group bookings?",
    answer:
      "Yes! We offer a 10% discount for bookings of 5 or more participants. For larger groups (10+), please contact us for custom pricing. We can also arrange private courses at your premises for groups of 12 or more.",
  },
  {
    id: "certificate",
    question: "When will I receive my certificate?",
    answer:
      "Certificates are issued on the same day upon successful completion of the course. Digital certificates are emailed within 24 hours, and physical certificates are posted within 3-5 working days. All certificates are valid for 3 years.",
  },
  {
    id: "requirements",
