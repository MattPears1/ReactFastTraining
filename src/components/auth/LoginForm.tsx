...
import { useAnnouncement, useFieldErrorAnnouncements, useReducedMotion } from '@/hooks/useAccessibility'
...
const LoginForm: React.FC<LoginFormProps> = ({ onSubmit, onSocialLogin, className }) => {
  ...
  const handleFormSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      setError(err)
      announce('Sign in failed. Please check your credentials and try again.', 'assertive')
    } finally {
      setIsLoading(false)
    }
  }
