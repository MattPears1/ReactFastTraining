...
interface RegisterFormProps {
  ...
  onSocialSignup?: (provider: 'google' | 'github' | 'twitter') => void
  className?: string
}
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <button
            ...
            className="flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
          >
