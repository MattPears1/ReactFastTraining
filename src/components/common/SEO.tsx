...
const defaultMeta = {
  ...
  description:
    "Yorkshire's premier first aid training provider. Emergency First Aid at Work, EFAW courses from £75. HSE approved & Ofqual regulated training in Leeds, Sheffield, Bradford.",
  keywords:
    "first aid training Yorkshire, first aid courses Leeds, first aid courses Sheffield, first aid courses Bradford, EFAW training Yorkshire, emergency first aid at work, HSE approved first aid, Ofqual regulated training",
...
const SEO: React.FC<SEOProps> = ({
  ...
  const organizationSchema = {
    ...
    description:
      "Yorkshire's premier first aid training provider offering Emergency First Aid at Work, Paediatric First Aid, and other HSE approved courses.",
    ...
    founder: {
      ...
      description:
        "Ex-military professional with over 20 years experience in emergency first aid and medical training.",
    },
    aggregateRating: {
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "1-day HSE approved course covering emergency first aid skills",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Specialized first aid training for those working with children",
            provider: { "@type": "Organization", name: "React Fast Training" },
          },
        },
      ],
  ...
  const websiteSchema = {
    ...
    name: "React Fast Training",
    description:
      "Yorkshire's premier first aid training provider - HSE approved & Ofqual regulated courses",
    potentialAction: {
      "@type": "SearchAction",
      target: {
        "@type": "EntryPoint",
