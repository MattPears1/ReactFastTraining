...
export const Card = ({
  ...
  return (
    <CardContext.Provider
      value={{ variant, isHoverable: hoverable, isClickable: clickable }}
    >
      <div
        className={cn(
          baseClasses,
...
Card.Header = ({
  ...
  return (
    <div className={cn("px-6 py-4", borderClass, className)}>{children}</div>
  );
};
...
export const Tabs = ({
  ...
  return (
    <TabsContext.Provider
      value={{ activeTab, setActiveTab: handleTabChange, tabs, variant }}
    >
      <div>{children}</div>
    </TabsContext.Provider>
  );
