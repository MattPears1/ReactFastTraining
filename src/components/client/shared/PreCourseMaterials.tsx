...
export const PreCourseMaterials: React.FC<PreCourseMaterialsProps> = ({
  ...
  const viewedRequiredCount = materials.filter(
    (m) => m.isRequired && m.viewed,
  ).length;
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-blue-800 dark:text-blue-300">
                Required Materials: {viewedRequiredCount} of {requiredCount}{" "}
                viewed
              </p>
              <p className="text-sm text-blue-700 dark:text-blue-400 mt-1">
                Please review all required materials before attending the
                course.
              </p>
            </div>
          </div>
