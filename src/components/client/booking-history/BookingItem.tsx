...
const BookingItemComponent: React.FC<BookingItemProps> = ({ booking, onSelect }) => {
...
export const BookingItem = memo(BookingItemComponent, (prevProps, nextProps) => {
  return (
    ...
    prevProps.booking.certificateAvailable === nextProps.booking.certificateAvailable
  );
});