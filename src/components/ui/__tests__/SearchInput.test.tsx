...
describe("SearchInput", () => {
  ...
  it("handles enter key to search", async () => {
    const user = userEvent.setup();
    render(<SearchInput value="test query" onSearch={mockOnSearch} />);
  ...
  it("shows recent searches when focused with empty input", async () => {
    ...
    render(<SearchInput recentSearches={recentSearches} />);
  ...
  it("shows trending searches when enabled", async () => {
    ...
    render(
      <SearchInput showTrending={true} trendingSearches={trendingSearches} />,
    );
  ...
  it("handles arrow key navigation", async () => {
    const user = userEvent.setup();
    render(<SearchInput value="test" suggestions={mockSuggestions} />);
