...
describe("NewsletterForm Component", () => {
  ...
  it("shows privacy policy link when provided", () => {
    renderWithQueryClient(<NewsletterForm privacyPolicyUrl="/privacy" />);
  ...
  it("requires consent when GDPR checkbox is shown", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/you must agree to receive/i),
      ).toBeInTheDocument();
    });
    ...
    await waitFor(() => {
      expect(
        screen.queryByText(/you must agree to receive/i),
      ).not.toBeInTheDocument();
    });
  });

  it("supports custom submit button text", () => {
    renderWithQueryClient(<NewsletterForm submitButtonText="Join Now" />);
  ...
  it("applies custom className", () => {
    renderWithQueryClient(<NewsletterForm className="custom-newsletter" />);
