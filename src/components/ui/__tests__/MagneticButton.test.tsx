...
describe("MagneticButton Component", () => {
  ...
  it("adjusts strength of magnetic effect", () => {
    ...
    rerender(<MagneticButton strength={2}>Strong Magnetic</MagneticButton>);
  ...
  it("can be disabled", () => {
    render(<MagneticButton disabled>Disabled Button</MagneticButton>);
  ...
  it("applies custom className", () => {
    render(
      <MagneticButton className="custom-magnetic">Custom Class</MagneticButton>,
    );
