...
const MagneticButton = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "relative inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden";
    ...
    const variants = {
      ...
      outline:
        "border-2 border-current hover:bg-gray-50 dark:hover:bg-gray-800",
      ...
      >
        ...
        <span className="relative z-10 flex items-center gap-2">
          ...
          <motion.span
            animate={{
              letterSpacing:
                position.x !== 0 || position.y !== 0 ? "0.05em" : "0em",
            }}
