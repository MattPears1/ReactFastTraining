        ...
        <div className="p-8">
          ...
          <ul className="space-y-2 mb-6">
            {features.map((feature, index) => (
              ...
              >
                <CheckCircle className={cn('w-4 h-4', `text-${color}-600 dark:text-${color}-400`)} />
          ...
          <motion.div 
            className="mt-4 inline-flex items-center gap-2 px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full text-sm font-medium relative overflow-hidden"
          >
