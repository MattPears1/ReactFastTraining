...
const alertStyles = {
  info: {
    ...
    button:
      "text-blue-800 dark:text-blue-200 hover:text-blue-900 dark:hover:text-blue-100 bg-blue-100 dark:bg-blue-800/30 hover:bg-blue-200 dark:hover:bg-blue-800/50",
    close:
  ...
  success: {
    ...
    button:
      "text-green-800 dark:text-green-200 hover:text-green-900 dark:hover:text-green-100 bg-green-100 dark:bg-green-800/30 hover:bg-green-200 dark:hover:bg-green-800/50",
    close:
  ...
  warning: {
    ...
    button:
      "text-yellow-800 dark:text-yellow-200 hover:text-yellow-900 dark:hover:text-yellow-100 bg-yellow-100 dark:bg-yellow-800/30 hover:bg-yellow-200 dark:hover:bg-yellow-800/50",
    close:
  ...
  error: {
    ...
    button:
      "text-red-800 dark:text-red-200 hover:text-red-900 dark:hover:text-red-100 bg-red-100 dark:bg-red-800/30 hover:bg-red-200 dark:hover:bg-red-800/50",
    close:
