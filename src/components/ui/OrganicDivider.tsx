...
export const OrganicDividerPatterns = {
  ...
  layeredWaves: (color1 = '#6A37FF', color2 = '#FF0057') => (
    <div className="relative">
      <OrganicDivider variant="wave" color={color1} className="absolute inset-0 opacity-50" />
      <OrganicDivider variant="wave" color={color2} className="relative opacity-50" />
    </div>
  ),
