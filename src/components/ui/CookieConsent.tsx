  ...
  return (
    <>
      <AnimatePresence>
        {isVisible && (
          <motion.div
            initial={{ y: position === 'bottom' ? 100 : position === 'top' ? -100 : 0, opacity: position === 'center' ? 0 : 1 }}
            animate={{ y: 0, opacity: 1 }}
            exit={{ y: position === 'bottom' ? 100 : position === 'top' ? -100 : 0, opacity: position === 'center' ? 0 : 1 }}
            className={cn(
              'fixed z-50 p-4',
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <div className={cn(
                        ...
                        category.required ? 'opacity-50 cursor-not-allowed' : 'peer-checked:bg-primary-600'
                      )} />
                    </label>
                  </div>
                </div>
