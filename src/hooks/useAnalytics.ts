...
import { analytics, AnalyticsEvent, EcommerceEvent, ConversionEvent } from '@/services/analytics/analytics.service'
...
export const useFormTracking = (formName: string) => {
  ...
  const trackFormError = useCallback((field: string, error: string) => {
    analytics.trackEvent({
      category: 'form',
      action: 'error',
      label: formName,
